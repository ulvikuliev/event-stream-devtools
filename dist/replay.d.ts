 ...
 */
export declare const replayEvents: <TEvent, TState>(events: RecordedEvent<TEvent>[], cursor: number, reducer: EventReducer<TEvent, TState>) => ReplayedState<TState> | null;
