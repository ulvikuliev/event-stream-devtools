...
const IconSkipStart = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon", "aria-hidden": true, children: _jsx("path", { d: "M2 1.5h1.5v9H2z M10.5 1.5 4.5 6l6 4.5z" }) }));
const IconStepBack = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon", "aria-hidden": true, children: _jsx("path", { d: "M9.5 1.5 3.5 6l6 4.5z" }) }));
const IconPlay = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon esd-icon-lg", "aria-hidden": true, children: _jsx("path", { d: "M2.5 1 11 6l-8.5 5z" }) }));
const IconPause = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon esd-icon-lg", "aria-hidden": true, children: _jsx("path", { d: "M2.5 1.5H5v9H2.5z M7 1.5h2.5v9H7z" }) }));
const IconStepForward = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon", "aria-hidden": true, children: _jsx("path", { d: "M2.5 1.5 8.5 6l-6 4.5z" }) }));
const IconSkipEnd = () => (_jsx("svg", { viewBox: "0 0 12 12", className: "esd-icon", "aria-hidden": true, children: _jsx("path", { d: "M1.5 1.5 7.5 6l-6 4.5z M8.5 1.5H10v9H8.5z" }) }));
